// English project copy. Language-independent data (URLs, stack, images) lives in lib/projects.ts.
...
export const projectsEn = {
  y2notion: {
    ...
    heroImageAlt:
      "Y2Notion homepage with a YouTube link pasted into the input next to the Summarize button",
    galleryAlts: [
      "Notion location picker opened above a summary, with the YouTube Summaries page selected",
      "Generated Markdown summary of a JavaScript video with Copy and Save to Notion actions",
    ],
    caseStudy: {
      problem: [
  ...
  "hairsalon-booking": {
    ...
    role: "Solo developer",
    heroImageAlt:
      "The Blade barbershop homepage with a Book your appointment button",
    galleryAlts: [
      "Reservation form with name, phone, email, service, date and timeslot fields",
      "Barber dashboard listing reservations by date and timeslot, with status and date filters",
    ],
    caseStudy: {
      problem: [
